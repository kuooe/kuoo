package kr.kuooe.Vopet.main.controller;
...
@Controller
public class MainVPController {
	public Logger log = LoggerFactory.getLogger(this.getClass());
	
    @Autowired
    private ClickCountRepository clickCountRepository;

    @RequestMapping("/Vopet/")
	public String VopetMain(HttpServletRequest request, HttpServletResponse response, ModelMap model, RedirectAttributes redirectAttributes) {
		log.debug("VopetMain() =====> Start");
		log.debug("VopetMain() =====> End");
		return "Vopet/Main";
	}
    /*
